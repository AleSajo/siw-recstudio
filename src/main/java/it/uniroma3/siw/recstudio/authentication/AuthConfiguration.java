package it.uniroma3.siw.recstudio.authentication;
...
import static it.uniroma3.siw.recstudio.model.Credentials.ADMIN_ROLE;
//import static it.uniroma3.siw.spring.recstudio.Credentials.DEFAULT_ROLE;
...
@Configuration
@EnableWebSecurity
@EnableGlobalMethodSecurity(prePostEnabled = true)	//aggiunto dopo
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/", "/home", "/login", "/register", "/images/**").permitAll()
                // chiunque (autenticato o no) può mandare richieste POST al punto di accesso per login e register 
                .antMatchers(HttpMethod.POST, "/login", "/register","/home").permitAll()
                // solo gli utenti autenticati possono prenotarsi
                .antMatchers("/prenota/**").authenticated()
